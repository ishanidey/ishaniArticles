...
const PostCard = ({ post }) => (
  <div className="bg-green p-0 lg:p-1 pb-4 mb-4">
    ...
    <h2 className="transition duration-700 mb-8 cursor-pointer text-3xl font-semibold  text-white">
      <Link href={`/post/${post.slug}`}>{post.title}</Link>
    </h2>
    <div className="block lg:flex mb-8 w-half">
      <div className="flex mb-4 lg:mb-0 w-half lg:w-auto mr-8 ">
        <Image
          unoptimized
          loader={grpahCMSImageLoader}
    ...
    <p className="text-center text-lg font-semibold px-4 lg:px-20 mb-8">
      {post.excerpt}
    </p>
    <div className="text-center">
      <Link href={`/post/${post.slug}`}>
        <span className="cursor-pointer color-">Click to Continue Reading</span>
      </Link>
    </div>
  </div>
);
